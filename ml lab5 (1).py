...
# ========== CONFIGURATION ==========
CSV_PATH = r"C:\Users\tammi\OneDrive\Documents\Desktop\project k\sample_0_venom_nonvenom.csv"  # path to your CSV file
IMAGE_DIR = r"C:\Users\tammi\OneDrive\Documents\Desktop\project k\images"  # folder where all images are stored
...
for idx, row in tqdm(df_subset.iterrows(), total=len(df_subset)):
    img_path = os.path.join(IMAGE_DIR, row["uuid_image"])
    ...
    try:
        ...
        feat = model.predict(x, verbose=0)[0]   # add verbose=0 to suppress logs
